...
function naruto() {
  ...
  // Type 'naruto' on your keyboard
  var key = [78, 65, 82, 85, 84, 79]; // N, A, R, U, T, O
  var ck = 0;
  var max = key.length;

  var summonNaruto = function () {
    var img = new Image();
    img.src = "https://i.ibb.co/ksS692xv/96bd57dfd46d27a32d435ad8eb82a997.gif";
...
function itachi() {
  ...
  var key = [73, 84, 65, 67, 72, 73];
  var ck = 0;
  var max = key.length;

  var summonitachi = function () {
    var img = new Image();
    img.src = "https://i.ibb.co/qM1dnQG2/2f006a4527ed1dfd886558bf8a7123f0.gif";
    img.style.width = "280px";
    img.style.height = "200px";
    img.style.position = "fixed";
    img.style.left = "-300px";
...
function narutoDance() {
  ...
  // Type 'naruto' on your keyboard
  var key = [68, 65, 78, 67, 69]; // D, A, N, C, E
  // N, A, R, U, T, O
  var ck = 0;
  var max = key.length;
  ...
  var summonNaruto = function () {
    var img = new Image();
    img.src = "https://i.ibb.co/h1dMwc3y/e884990a7863c90811e37b275cae3f0c.gif";
    img.style.width = "280px";
    img.style.height = "200px";
    img.style.position = "fixed";
    img.style.left = "-300px";
